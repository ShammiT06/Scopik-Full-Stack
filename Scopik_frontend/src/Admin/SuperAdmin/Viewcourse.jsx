...
//   return (
//     <div className="p-6 bg-white rounded-lg shadow-md max-w-screen-xl mx-auto">
...
//           <div className="bg-white p-10 rounded-lg shadow-md w-full max-w-5xl relative max-h-[90vh] overflow-y-auto">
//             <div className="flex justify-between items-center mb-4 py-3 px-2 sticky top-0 bg-white z-10">
...
//             <div className="">
//               <label className="font-medium text-black">Course Name</label>
//               <input
...
//               />
//               <label className="font-medium text-black">Total Chapters</label>
//               <input
...
//                 className="w-full border p-2 rounded mb-4"
//               />
//               <label className="font-medium text-black">Duration</label>
//               <input
...
//           <div
//             key={course.id}
//             className="bg-white border hover:shadow-md p-4 rounded-md flex flex-col justify-between"
//           >
//             <img
//               src={course.image}
//               alt={course.name}
...
//               <h2 className="text-lg font-bold text-blue-900">{course.name}</h2>
...
//       {showAddChapterModal && (
//         <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
//           <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-4xl h-[90vh] overflow-y-auto relative">
//             <IoClose
//               size={26}
...
//               ></div>
//             </div>
//             <p className="mb-2 text-gray-600">Step {currentStep} of 3</p>
