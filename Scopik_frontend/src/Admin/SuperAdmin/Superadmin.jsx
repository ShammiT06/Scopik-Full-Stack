...
case "contact":
  ...
  const sidebarItems = [
    ...
    { id: "people", icon: <Users2 size={20} />, label: "Students" },
  ...
  return (
    <>
      ...
      <div className="flex w-full bg-gradient-to-r from-[#61CBF3] to-[#074c83] pt-[80px] min-h-screen relative">
        {/* Sidebar */}
        <div
          className={`fixed top-[60px] left-0 h-[calc(100vh-60px)] transition-all duration-300 bg-white shadow-lg z-0 ${
          ...
          <div className="flex flex-col items-start h-full p-3 overflow-y-auto">
            ...
            {sidebarItems.map((item) => (
              <div
                ...
                className={`flex items-center gap-3 p-2 my-1 rounded-md cursor-pointer w-full transition-all duration-200 hover:bg-blue-50 ${
                  color === item.id
