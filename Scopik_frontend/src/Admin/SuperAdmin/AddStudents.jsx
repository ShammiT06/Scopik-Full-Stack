...
//   const yearValue = s.academicYear || s.academic_year; // normalize here
...
//       activeTab === (tab === "Overall Students" ? "all" : tab.toLowerCase())
...
//       value={selectedUniversity}
//       onChange={(e) => setSelectedUniversity(e.target.value)}
//       className="p-2 rounded border text-lg focus:outline-none focus:ring-2 focus:ring-blue-500 w-[600px]"
//     >
//       {universities.map((uni, index) => (
//         <option key={index} value={uni.name}>
//           {uni.name}
...
//   className="p-2 rounded border text-lg focus:outline-none focus:ring-2 focus:ring-blue-500 w-[400px]"
// >
...
//       value={filterYear}
//       onChange={(e) => setFilterYear(e.target.value)}
//       className="p-2 rounded border text-lg focus:outline-none focus:ring-2 focus:ring-blue-500 w-[200px]"
//     >
//       <option value="">Filter by Year</option>
//       <option value="1">1st Year</option>
//       <option value="2">2nd Year</option>
