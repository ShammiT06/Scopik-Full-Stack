...
function SemesterList() {
  ...
  return (
    <>
      <div className="p-4 sm:p-6 lg:p-8 bg-white rounded-lg shadow-lg max-w-6xl mx-auto dark:bg-slate-900">
        {/* ✅ Responsive Header */}
        ...
        {showForm && (
          <div className="bg-blue-50 border border-blue-300 rounded-lg p-4 sm:p-6 lg:p-8 mb-10 shadow-inner">
            <h2 className="text-lg sm:text-xl font-semibold text-blue-900 mb-6 text-center sm:text-left">
              {editMode ? "Edit Semester" : "Create New Semester"}
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div>
                ...
                <input
                  ...
                  value={semesterNumber}
                  onChange={(e) => setSemesterNumber(e.target.value)}
                  className="border border-gray-300 rounded-md p-2 sm:p-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
    ...
    semesters.map((semester) => {
      ...
      return (
        ...
        >
          ...
          <div className="mb-4">
            <p className="font-semibold text-gray-700 mb-1 dark:text-white">
              Courses:
            </p>
          ...
          {/* ✅ Centered buttons & scroll on edit */}
