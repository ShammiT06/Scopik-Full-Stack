...
export default function TermsAndConditions() {
    ...
    return (
        <div className={darkMode ? "dark" : ""} id="no-copy">
            <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900 dark:text-gray-100">
                {/* Banner */}
                ...
                {/* Content */}
                <main className="flex-1 container mx-auto px-6 py-12 leading-relaxed dark:bg-black">
