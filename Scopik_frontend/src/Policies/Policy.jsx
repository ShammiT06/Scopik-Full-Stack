export default function PrivacyPolicy() {
  ...
  return (
    <div className="flex flex-col min-h-screen" id="no-copy">
      <section className="bg-gradient-to-r from-purple-600 to-indigo-600 py-12 mt-10">
        <div className="container mx-auto px-6 text-center">
          <h1
            className="text-[48px] font-bold text-white dark:text-orange-400"
      ...
      <main className="flex-1 container mx-auto px-6 py-12 text-gray-800 leading-relaxed dark:bg-black dark:text-white">
        <article className="max-w-4xl mx-auto">
          <h2
            className="text-xl font-bold mb-4 dark:text-orange-400"
            style={{ fontFamily: "Newsreader, sans-serif" }}
          >
            Privacy Policy for Scopik Education Pvt Ltd
          </h2>
          <p>
            At lms.scopik.in , accessible from{" "}
            www.lms.scopik.in, one of our main priorities is
            the privacy of our visitors. This Privacy Policy document contains
            types of information that is collected and recorded by{" "}
            lms.scopik.in and how we use it. If you have
            ...
            collect in lms.scopik.in. This policy is not
            applicable to any information collected offline or via channels
            other than this website.
          </p>
          <h2
            className="text-xl font-bold mt-8 mb-4 dark:text-orange-400"
            style={{ fontFamily: "Newsreader, sans-serif" }}
          >
            Consent
          </h2>
          ...
          <p>
            ...
            <p>If you
              ...
              you may choose to provide.</p>
            <p>When you register for an account, we may
          ...
          <p>
            lms.scopik.in follows a standard procedure of using
          ...
          <p>
            Like any other website,lms.scopik.in uses
          ...
          <p>
            Note that lms.scopik.in has no access to or control
          ...
          <p>
            lms.scopik.in&apos;s Privacy Policy does not apply
          ...
          <p>Under the CCPA, among other rights, Cslifornia consumers have the right to:</p>
          <p>Request that a business that collects a consumer's personal data disclose the categories and specific pieces of personal data that a business has collected about consumers.</p>
          <p>Request that a business delete any personal data about the consumer that a buiseness has collected.</p>
          ...
          <p><b>The right to object to processing –</b> You have the right to request that we restrict the processing of your personal data, under certain conditions.</p>
          ...
          <p>Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity. lms.scopik.in does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>
