...
//     try {
//       await axios.post(
//         "https://lmsdemo.thirdvizion.com/api/bulkupload/",
//         { users: bulkUsers }
//       );
//       setBulkUsers([]);
//       setSub(false);
...
//     }
//     axios
//       .post("http://127.0.0.1:8000/api/assigncoursetofaculty/", {
...
//   return (
//     <div className={`w-full min-h-screen px-4 py-8 ${isDarkMode ? "bg-slate-900 text-white" : "bg-gray-50 text-gray-800"}`}>
...
//       {showUploadOptions && (
//         <div className={`shadow-lg rounded-lg p-6 mb-6 ${isDarkMode ? "bg-slate-800" : "bg-white"}`}>
...
//               <input type="text" value={univ} placeholder="University Name" className={inputStyle} />
...
//               <button onClick={addTeacher} className="col-span-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700">Register</button>
//             </div>
//           )}
//           {uploadType === "bulk" && (
...
//               </p>
//               <input type="file" onChange={bulkFile} className={`border border-dashed border-blue-400 p-5 rounded cursor-pointer text-sm transition ${isDarkMode ? "bg-slate-800 text-gray-300 hover:bg-slate-700" : "bg-white hover:bg-blue-50 text-gray-700"}`} />
...
//       <div className={`rounded-lg shadow p-6 ${isDarkMode ? "bg-slate-800" : "bg-white"}`}>
//         <div className="flex justify-between items-center mb-4">
//           <h2 className="text-xl font-semibold dark:text-white">Faculty Members</h2>
...
//               ))}
//             </select>
//             <button onClick={exportSelected} className="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">Export CSV</button>
//           </div>
//         </div>

//         {filteredTeachers.length > 0 && (
//           <div className="flex items-center gap-2 mb-2">
//             <input type="checkbox" checked={selectAll} onChange={toggleSelectAll} className="form-checkbox h-4 w-4 text-blue-600" />
...
//               <div key={i} className="flex justify-between items-center border-b py-2 text-gray-800 dark:text-white text-sm sm:text-base">
...
//                 <span key={idx} className="bg-blue-200 dark:bg-blue-600 px-3 py-1 rounded-full text-sm">
//                   {courseName}
//                   <button onClick={() => removeCourse(courseName)} className="ml-2 text-red-600 font-bold">�</button>
//                 </span>
//               ))}
//             </div>
//             <div className="flex justify-end gap-2 mt-4">
//               <button onClick={() => setEditingTeacher(null)} className="bg-gray-400 text-white px-4 py-2 rounded">Cancel</button>
//               <button onClick={assignCoursesToTeacher} className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">Assign</button>
//             </div>
//           </div>
//         </div>
//       )}
...
//           <div className={`p-6 rounded-lg shadow-lg w-full max-w-sm text-center ${isDarkMode ? "bg-slate-800 text-white" : "bg-white text-gray-800"}`}>
//             {modalIcon}
//             <p className="mt-3 mb-4 text-lg">{modalMessage}</p>
//             <button onClick={() => setShowModal(false)} className="w-full py-2 rounded bg-blue-600 text-white hover:bg-blue-700 transition">
//               OK
//             </button>
//           </div>
//         </div>
