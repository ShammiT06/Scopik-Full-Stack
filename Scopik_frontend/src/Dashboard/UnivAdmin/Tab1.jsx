...
function Teacherhome() {
  ...
  return (
    ...
    >
      {/* Top Profile Section */}
      <div
        className="relative h-auto sm:h-[300px] rounded-xl bg-white dark:bg-slate-800 backdrop-blur-md border border-white/30 shadow-md flex flex-col sm:flex-row items-center justify-start gap-6 sm:gap-10 p-6"
        style={{
