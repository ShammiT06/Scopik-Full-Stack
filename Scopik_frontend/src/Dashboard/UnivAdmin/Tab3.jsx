...
//         name,
//         email: email.toLowerCase(), // ensure lowercase here too
//         user_type: "student",
//         department,
...
//         "https://lmsdemo.thirdvizion.com/api/studentdelete/",
//         {
//           data: {
//             select_all: false,
...
//           >
//             <FaUserPlus /> {showUploadOptions ? "Hide Add Student" : "Add Student"}
//           </button>
//           <input
//             type="text"
//             placeholder="Search..."
...
//               <input type="email" value={email} onChange={(e) => setEmail(e.target.value.toLowerCase())} placeholder="Email ID" className={inputStyle} />
...
//               <input type="tel" value={phone} maxLength={10} onChange={(e) => setPhone(e.target.value)} placeholder="Phone Number" className={inputStyle} />
