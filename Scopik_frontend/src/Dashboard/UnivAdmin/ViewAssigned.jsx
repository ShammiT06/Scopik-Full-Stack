...
// import useTheme from "/src/Hooks/ThemeHook"; // Dark/Light theme hook
...
//       })
//       .then((res) => {
//         setFacultyData(res.data); // set API response to state
//       })
...
//                         </div>
//                       </div>
//                       {/* Remove Button (UI only, no functionality yet) */}
//                       <button
...
function FacultyList() {
  ...
  const [deleteInfo, setDeleteInfo] = useState(null); // holds facultyEmail + courseName to delete
