...
//   return (
//     <div className={`w-full px-4 py-6 md:px-8 lg:px-16 ${isDarkMode ? "bg-gray-900" : "bg-gray-100"}`}>

//       <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
//         <h1 className={`text-3xl md:text-4xl font-semibold ${isDarkMode ? "text-orange-400" : "text-[#084E90]"}`}>
...
//         <p className={`text-center ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>No student found.</p>
//       ) : (
...
//                       onError={(e) => (e.currentTarget.src = "/default-student.png")}
...
function Teacherthird() {
  ...
  const filteredStudents = (students || []).filter((s) => {
    ...
    const yearValue = s.academicYear || s.academic_year || s.year || ""; // flexible
