...
const HeroSlider = () => {
  ...
  return (
  <div className="relative w-full h-[400px] max-w-full overflow-hidden">
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-black/70 dark:from-black/60 dark:via-black/40 dark:to-black/70" />
